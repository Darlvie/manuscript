...
- (NSArray *)titleArray {
    if (!_titleArray) {
        _titleArray = @[NSLocalizedString(@"ManuscriptState", @"State"),
                        NSLocalizedString(@"ManuscriptID", @"ID"),
                        NSLocalizedString(@"ManuscriptAuthor", @"Author"),
                        NSLocalizedString(@"SaveUser", @"SaveUser"),
                        NSLocalizedString(@"Department", @"Department"),
                        NSLocalizedString(@"ManuscriptDate", @"Date"),
                        NSLocalizedString(@"ManuscriptChannel", @"Channel"),
                        NSLocalizedString(@"SentDevice", @"Device")
                        ];
    }
    return _titleArray;
}
...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedString(@"Manuscript Detail", @"Manuscript Detail");
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    if (section == 0) {
        ...
        return NSLocalizedString(@"ManuscriptDetail", @"Detail");
    }
}
