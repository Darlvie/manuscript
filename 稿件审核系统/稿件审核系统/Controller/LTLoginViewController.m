...
- (void)setupInputView {
    ...
    _userNameTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Account", @"Account") attributes:@{NSForegroundColorAttributeName:[UIColor lightGrayColor]}];
    ...
    _passwordTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Password", @"Password") attributes:@{NSForegroundColorAttributeName:[UIColor lightGrayColor]}];
...
- (void)loginButtonClick {
    ...
    if ([self.userNameTextField.text isEqualToString:@""] || [self.passwordTextField.text isEqualToString:@""]) {
        [SVProgressHUD showErrorWithStatus:NSLocalizedString(@"LogInShowEmptyError", @"User name or password can not be empty")
       ...
       if ([self.userNameTextField.text isEqualToString:self.account.userName] && [self.passwordTextField.text isEqualToString:self.account.password]) {
            [SVProgressHUD showSuccessWithStatus:NSLocalizedString(@"LogInShowSuccess", @"LogIn successful")
                                        maskType:SVProgressHUDMaskTypeBlack];
            ...
            [SVProgressHUD showErrorWithStatus:NSLocalizedString(@"LogInShowVerifyError", @"User name or password is incorrect")
                                      maskType:SVProgressHUDMaskTypeBlack] ;
        }
